...
const retrieve = (req, res)=>{
    connection.query('SELECT * FROM node-complete', (err, result)=>{
...
const create = (req, res)=>{
    ...
    const query = 'INSERT INTO node-complete (name, email, number) VALUES (?, ?, ?)';
...
const deleteuser =  (req, res)=>{
    ...
    const query = 'DELETE FROM node-complete WHERE id=?'
